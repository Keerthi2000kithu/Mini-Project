            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <div class="form-outline mb-4">
                  ...
                  <div class="pt-1 mb-4">
                    <button name='sub'  class="btn btn-dark btn-lg btn-block" type="submit">Login</button>
                  </div>
...
$sql = "SELECT `id`, `name`, `mobile`, `email`, `password` FROM
 `users` WHERE `email`='$getEmail' and `password` = '$getPassword' ";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
  // output data of each row
  echo "<script> window.location.href='newtest.php' </script>";
